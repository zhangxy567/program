...
CREATE TABLE stu  (
  ...
  CONSTRAINT stu_fk FOREIGN KEY (classid) REFERENCES class (classid) ON DELETE RESTRICT ON UPDATE RESTRICT
...
CREATE TABLE sc  (
  ...
  CONSTRAINT `sc_fk_1` FOREIGN KEY (sno) REFERENCES stu (sno) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `sc_fk_2` FOREIGN KEY (cno) REFERENCES course (cno) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
-- ----------------------------
-- Records of sc
-- ----------------------------
...
CREATE TABLE course  (
  ...
  CONSTRAINT `course_fk` FOREIGN KEY (tno) REFERENCES teacher (tno) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
-- ----------------------------
-- Records of course
-- ----------------------------
...
CREATE TABLE teaching  (
  ...
  INDEX cno(cno) USING BTREE,
  CONSTRAINT teaching_fk_1 FOREIGN KEY (tno) REFERENCES teacher (tno) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT teaching_fk_2 FOREIGN KEY (cno) REFERENCES course (cno) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
-- ----------------------------
-- Records of setup
-- ----------------------------
